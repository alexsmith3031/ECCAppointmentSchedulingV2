...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { claimNumber: @insurance.claimNumber, companyName: @insurance.companyName, customer_id: @insurance.customer_id, yesno: @insurance.yesno } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { claimNumber: @insurance.claimNumber, companyName: @insurance.companyName, customer_id: @insurance.customer_id, yesno: @insurance.yesno } }
